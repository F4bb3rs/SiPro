...
def computeMostFrequentChars(freq_table, n):
    ...
    for i in range(0, n):	    # Dictionary wird absteigend sortiert, zuerst nach der Häufigkeit und bei gleicher Häufigkeit nach den Zahlen selbst
    # Für die gewünschte Anzahl der häufigsten Zahlen
